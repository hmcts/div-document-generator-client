...
public class TemplateConstants {
    ...
    public static final String DA_HAS_BEEN_GRANTED_LETTER_TEMPLATE_ID = "FL-DIV-GOR-ENG-00355.docx";
    ...
    public static final String DA_HAS_BEEN_GRANTED_LETTER_TEMPLATE_NAME = "DecreeAbsoluteGrantedLetter.pdf";
