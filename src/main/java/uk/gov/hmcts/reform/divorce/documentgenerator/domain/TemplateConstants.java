...
public class TemplateConstants {
    ...
    public static final String COE_CORESPONDENT_SOLICITOR_COVER_LETTER_TEMPLATE_ID = "FL-DIV-GNO-ENG-00447.docx";
    ...
    public static final String COE_CORESPONDENT_SOLICITOR_COVER_LETTER_PDF_FILE = "CoE_CoRespondent_CoverLetter.pdf";
