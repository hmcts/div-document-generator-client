...
public class TemplateConstants {
    ...
    public static final String AOS_INVITATION_RESP_TEMPLATE_ID = "aosinvitation-rep-resp-journey";
    ...
    public static final String AOS_OVERDUE_COVER_LETTER_FILE_NAME = "AosOverdueCoverLetter.pdf";
    ...
    public static final String CTSC_OPENING_HOURS_KEY = "ctscOpeningHours";
    ...
    public static final String DN_COURT_CONTACT_KEY = "DecreeNisiCourtContactDetails";
