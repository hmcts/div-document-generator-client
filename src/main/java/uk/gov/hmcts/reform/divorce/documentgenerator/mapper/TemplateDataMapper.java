...
public class TemplateDataMapper {
    ...
    private void updateWithWelshTranslatedData(Map<String, Object> caseData) {
        ...
        Consumer<Map<String, Object>> welshConsumer = data -> {
            ...
            Optional.ofNullable(data.get(ISSUE_DATE_KEY)).map(String.class::cast).ifPresent(
                date -> data.put(WELSH_ISSUE_DATE_KEY, localDateToWelshStringConverter.convert(date)));
        };
