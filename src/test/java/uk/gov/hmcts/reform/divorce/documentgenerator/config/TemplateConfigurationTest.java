...
//
//        assertThat(templateConfiguration.getFileNameByTemplateName(COE_TEMPLATE), is(CERTIFICATE_OF_ENTITLEMENT_NAME_FOR_PDF_FILE));
//        assertThat(templateConfiguration.getFileNameByTemplateName(COSTS_ORDER_TEMPLATE), is(COSTS_ORDER_NAME_FOR_PDF_FILE));
